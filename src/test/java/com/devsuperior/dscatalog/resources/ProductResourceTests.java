...
public class ProductResourceTests {
	...
	@Test
	public void upDateShouldReturnResourcesNotFoundExceptionWhenIdNotExist() throws Exception {
	...
	public void findAllShouldReturnPage() throws Exception {
		...
		result.andExpect(status().isOk());
		//result actions são as ações tomadas após o processamento de uma requisição HTTP
	}
	...
	@Test
	public void findByIdShouldReturnResourcesNotFoundExceptionWhenIdNotExist() throws Exception {
		ResultActions result = mockMvc.perform(get("/products/{id}", nonExistingId));
		result.andExpect(status().isNotFound());
	}
